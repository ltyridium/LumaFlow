# LumaFlow
A timeline-based visual editor for choreographing, calibrating, and synchronizing light stick illumination with music
...
LumaFlow 通过串口发送 22 字节数据包控制 LED 设备：

```
[0xC0] [CH0_HI] [CH0_LO] ... [CH9_HI] [CH9_LO] [0xC1]
```

| 字节 | 内容 |
|------|------|
| 0 | `0xC0`（起始标志） |
| 1-20 | 10个通道数据，每通道 2 字节 |
| 21 | `0xC1`（结束标志） |
